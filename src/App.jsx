...
function Navigation({ session }) {
  ...
  return (
    <nav className="glass-panel" style={{ margin: '1rem auto', maxWidth: '1200px', padding: '1rem 2rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderRadius: '100px' }}>
